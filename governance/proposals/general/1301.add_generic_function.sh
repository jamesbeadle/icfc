...
PROPOSAL="(
    record {
        title = \"Create Add Initial Fixtures Callback Function\";          
        url = \"https://github.com/jamesbeadle/football_god/blob/master/src/data_canister/main.mo\";        
        summary = \"Proposal to create the endpoint for adding the callback function to add initial fixtures for a league's season in the data canister.\";
        action = opt variant {
            AddGenericNervousSystemFunction = record {
                id = 70000 : nat64;
                name = \"Add Initial Fixtures\";
                description = opt \"Function to add initial fixtures for the season.\";
                function_type = opt variant { 
                    GenericNervousSystemFunction = record { 
                        ...
                        target_method_name = opt \"addInitialFixtures\";
                    } 
                };
            }
        };
