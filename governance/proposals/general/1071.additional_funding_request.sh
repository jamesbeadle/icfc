...
PROPOSAL="(
    record {  
        title = \"Transfer 1,500 ICP to Waterway Labs\";  
        ...
        summary = \"
            ...
            Waterway Labs will undertake an SNS for our golf based DAO, ICGC within the next 30 days, aiming to raise further funding to continue development and promotion of our application ecosystem.
