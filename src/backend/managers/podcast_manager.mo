...
module {
    public class PodcastManager() {
        ...
        // private var podcastEntries : [(Principal, ICFCTypes.PodcastChannel)] = [];
        // private let podcasts = TrieMap.fromEntries<Principal, ICFCTypes.PodcastChannel>(
        //     podcastEntries.vals(),
        //     Principal.equal,
        //     Principal.hash,
        // );
        ...
        //     let podcast : ICFCTypes.PodcastChannel = {
        //         id = podcastId;
        //         name = name;
