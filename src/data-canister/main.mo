...
actor Self {
  ...
  public shared query ({ caller }) func getDataHashes(dto : ICFCQueries.GetDataHashes) : async Result.Result<BaseQueries.DataHashes, Enums.Error> {
  ...
  public shared ({ caller }) func getDataTotals(_ : ICFCQueries.GetDataTotals) : async Result.Result<ICFCQueries.DataTotals, Enums.Error> {
    assert callerAllowed(caller);
