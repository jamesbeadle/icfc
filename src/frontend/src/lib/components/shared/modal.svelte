...
{#if visible}
  <Portal>
    ...
    >
      ...
      >
        <div 
          class="bg-ModalBackground border border-ModalBorder rounded-lg relative max-h-[80vh] drop-shadow-[0_4px_16px_rgba(0,0,0,0.6)] transform-style-preserve-3d flex flex-col"
        >
