        ...
        <div class="flex flex-col h-full">
            <div class="flex items-center justify-between">
                ...
                <button
                    ...
                    class="z-30 flex items-center justify-center transition-transform duration-300 hover:scale-110"
                >
                    <CloseIcon className="w-8 h-8" fill="currentColor"></CloseIcon>
                </button>
            </div>
            ...
            <div class="flex flex-col flex-1">
                ...
                <p class="{isModal ? 'text-xs xxs:text-sm xs:text-base mini:text-xs md:text-sm base:text-xs lg:text-sm 2xl:text-xs 3xl:text-sm' : 'text-sm xxs:text-base xs:text-lg mini:text-sm md:text-base base:text-sm lg:text-base 2xl:text-sm 3xl:text-base'} mb-4">
                    {app.description}
                </p>
                <a
                    href={app.link}
                    target="_blank"
                    class="px-6 py-3 mt-auto border text-center transition-colors duration-300 bg-transparent transform rounded-md shadow-md {app.textColor === 'text-white' ? 'border-BrandGrayShade6 hover:bg-BrandGrayShade6' : 'border-black hover:bg-black'} hover:shadow-lg hover:-translate-y-1 hover:text-{app.color}"
                >
                    Visit Website
                </a>
            </div>
